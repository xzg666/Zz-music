...
__DEFINE__(1652678236010, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652678236011,"./event-store":1652678236012}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652678236011, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652678236012, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652678236011,"./utils":1652678236013}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652678236013, function(require, module, exports) {
...
return __REQUIRE__(1652678236010);
})()
